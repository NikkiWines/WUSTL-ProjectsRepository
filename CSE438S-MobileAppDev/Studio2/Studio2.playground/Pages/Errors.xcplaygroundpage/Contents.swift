...
// error fixed by placing try in front of XCTAssertEqual(purchase(itemNumber: 1, currentStock: 1, inService: true), "Coke")
...
extension ErrorsTests {
    ...
    func test1Purchase() {
        try XCTAssertEqual(purchase(itemNumber: 1, currentStock: 1, inService: true), "Coke")
    }
