...
import hw5.nucleobase.ThreadNucleobaseCounter;

/**
 * A unit test for {@link ThreadNucleobaseCounter}.
 * 
 * @author Finn Voichick
 */
@RunWith(Parameterized.class)
public class CThreadNucleobaseCountTest {

	private static byte[] chromosome;
	private final Nucleobase nucleobase;
	private final int truthAndBeautyCount;
	private final ThreadNucleobaseCounter counter;
	...
	public CThreadNucleobaseCountTest(Nucleobase nucleobase) {
		this.nucleobase = nucleobase;
		counter = new ThreadNucleobaseCounter();
