...
/**
 * A unit test for {@link ThreadQuicksorter}.
 * 
 * @author Finn Voichick
 */
public final class BThreadQuicksortTest {
	@Test
	public void test() throws InterruptedException, ExecutionException {
		...
		ThreadQuicksorter sorter = new ThreadQuicksorter();
...
//public final class BThreadQuicksortTest {
//
//	private final ThreadQuicksorter sorter;
//	private final int[] array;
//	private final int[] sorted;
//	private final int threshold;
//
//	public BThreadQuicksortTest(int size, int threshold) {
//
//		sorter = new ThreadQuicksorter();
//
